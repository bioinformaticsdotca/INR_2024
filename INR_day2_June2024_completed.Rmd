...
```{r}
data <- read.csv("~/Downloads/BioinformaticsWorkshop_INR_June2024/water_potability.csv")
...
```{r}
heart <- read.csv("~/Downloads/BioinformaticsWorkshop_INR_June2024/healthcare-dataset-stroke-data.csv", stringsAsFactors=TRUE)
...
```{r}
diamonds <- read.csv("diamonds.csv", header = T, stringsAsFactors = T)
